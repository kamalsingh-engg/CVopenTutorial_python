        ...
        try:
            ...
            with pysftp.Connection('sb-emea.avl.com', username='abhishek.hingwasia@avl.com', password='AvlAvl2931!!',
                ...
                while True:
                    ...
                    localFilePath = '/home/pi/SFTP_IMG/{}/{}/{}/{}/{}/avlsecuritygateimg{}'.format(now.year, now.month,
                                                                                                   now.day, now.hour,
                                                                                                   now.minute,
                                                                                                   t1.second) + '.jpg'
                    remoteFilePath1 = '/Cummins_CTCI_NB/sftp_image_test/'
                    print(localFilePath)
                    try:
                        if sftp.exists(remoteFilePath1):
                            if os.path.exists(localFilePath):

                                remoteFilePath = '/Cummins_CTCI_NB/sftp_image_test/avlsecuritygateimg{}_{}_{}_{}'.format(
                                    now.date(), now.hour, now.minute, t1.second) + '.jpg'
            ...
            print('the connection has been lost to SSH most probably due to internet isssue')
            sleep(5)
...
def delete_folder():
    while True:
        ...
        localFilePath = '/home/pi/SFTP_IMG/{}/{}/{}/'.format(now.year, now.month, t2.day)
        if os.path.exists(localFilePath):
            shutil.rmtree(localFilePath)
            print("path removed")
            sleep(1)
